# CLAUDE.md — Just Bible

## Project Overview

성경 본문을 검색하고 복사할 수 있는 웹 애플리케이션.
...
- **파일/폴더**: kebab-case (`bible-verse-card.tsx`, `use-search.ts`)
- **컴포넌트**: PascalCase (`BibleVerseCard`, `SearchBar`)
- **함수/변수**: camelCase (`getVersesByChapter`, `isLoading`)
- **상수**: UPPER_SNAKE_CASE (`BOOK_NAMES`, `MAX_RESULTS`)
- **타입/인터페이스**: PascalCase, `I` 접두사 사용하지 않음 (`Verse`, `BookInfo`)
