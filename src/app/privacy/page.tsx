    ...
    <main className="mx-auto max-w-2xl px-6 py-20">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed dark:text-gray-300">
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            <strong>브라우저 저장소(localStorage)</strong>: 테마 설정, 역본 선택, 글자 크기 등 사용자 환경설정을 브라우저에 저장합니다. 이 정보는 이용자의 기기에만 저장되며, 서버로 전송되지 않습니다.
          </li>
          <li>
            <strong>쿠키(Cookie)</strong>: 서비스에 포함된 제3자 광고 서비스(Google AdSense 등)가 광고 제공 및 성과 측정을 위해 쿠키를 사용할 수 있습니다.
          </li>
        </ul>
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            <strong>Google AdSense</strong>: 맞춤 광고 제공을 위해 쿠키를 사용합니다.{" "}
          ...
          <li>
            <strong>Google Fonts</strong>: 웹 폰트 제공을 위해 Google 서버에 접속합니다.
          </li>
        </ul>
