              ...
              <div className="rounded-2xl border border-pink-200/70 bg-gradient-to-b from-pink-50 to-rose-50/60
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {[
                    ...
                    { icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="h-4.5 w-4.5"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>, title: "키워드 찾기", desc: "주제별 말씀을 찾아보세요", examples: ["사랑", "위로", "소망"] },
